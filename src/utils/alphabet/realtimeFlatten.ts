// Ported from the reference realtime client. No server-side normalization here.
...
// Reference handTracking.ts: serving payload is unmirrored; preview is visual only.
const MIRROR_SERVING_PAYLOAD = false;
