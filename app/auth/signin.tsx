...
export default function SignInScreen() {
  ...
  try {
    ...
    if (!data || !data.session) {
      // Trường hợp không có session (ví dụ yêu cầu verify email, cấu hình auth khác…)
      console.log("No session returned from Supabase:", data);
      Alert.alert('Error', 'Login failed. No active session returned.');
      return;
    }

    // Ở đây chắc chắn có session
